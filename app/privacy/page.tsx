        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-6 text-slate-700 leading-relaxed">
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">1. 個人情報の利用目的</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">2. 取得する情報</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">3. 第三者提供について</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">4. 安全管理について</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">5. 本ポリシーの変更</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-lg font-bold text-slate-800">6. お問い合わせ</h2>
              <p>
