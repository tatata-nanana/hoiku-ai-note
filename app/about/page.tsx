...
export const metadata: Metadata = {
  ...
  description:
    "保育AIノートは、保育士・幼稚園教諭・保育現場で働く方のための文章作成支援サービスです。活動文、ねらい、評価・反省、養護、援助・配慮、環境構成などの作成をサポートします。",
};
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-6 text-slate-700 leading-relaxed">
            <p>
              ...
              保育の現場では、日々の活動記録、ねらい、評価・反省、おたより、月案、週案、
              養護、援助・配慮、環境構成など、さまざまな文章を作成する場面があります。
            </p>
